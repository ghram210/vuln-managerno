                  ...
                  <div class="finding-card">
                    <div class="finding-header">
                      <div class="finding-title-container">
                        <svg class="finding-icon" viewBox="0 0 24 24" fill="currentColor"><path d="M5 21V5q0-.825.588-1.413T7 3h10q.825 0 1.413.588T19 5v11q0 .825-.588 1.413T17 18H7l-2 3Zm2-6.15L8.85 13H17V5H7v9.85ZM7 5v8-8Z"/></svg>
