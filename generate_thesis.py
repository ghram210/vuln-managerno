...
add_arabic_paragraph(doc, '3.10 المتطلبات الوظيفية وغير الوظيفية', is_heading=True, level=1)
add_arabic_paragraph(doc, "وظيفياً: يدعم النظام RBAC مع تقارير تنفيذية حصرية للمسؤول، وإدارة كاملة لدورة حياة الفحص. غير وظيفياً: يضمن النظام عزل البيانات عبر RLS وزمن استجابة سريع تحت الضغط.")
